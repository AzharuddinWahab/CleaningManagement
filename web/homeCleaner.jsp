<%-- 
    Document   : index
    Created on : May 7, 2024, 8:29:18 AM
    Author     : azhar
--%>
...
<html>
    ...
    <div align="center" style="margin-top: 60px;">
        <ul>
            <a href="taskListCleaner"><button type="button" class="btn btn-primary" style="background-color: #006666 !important;">View All Tasks</button></a>

            <a href="listReportsCleaner"><button type="button" class="btn btn-primary" style="background-color: #006666 !important;">View Reports</button></a>
        </ul>
    </div>
</body>
</html>