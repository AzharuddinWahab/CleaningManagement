                    ...
                    <c:forEach var="task" items="${listTasks}" varStatus="status">
                        <tr>
                            ...
                            <td class="action-column">
                                <div class="mb-2">
                                    <a href="edittaskcleaner?id=<c:out value='${task.id}' />" class="custom-button">Edit Task</a>
                                </div>
                                <div class="mb-2">
                                    <a href="listreportsbyidcleaner?id=<c:out value='${task.id}' />" class="custom-add">Add Reports</a>
                                </div>
                                <div class="mb-2">
                                    <a href="deletetaskCleaner?id=<c:out value='${task.id}' />" class="custom-delete">Task Completed</a>
                                </div>
                            </td>
                        </tr>
                    </c:forEach>
