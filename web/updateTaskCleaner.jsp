...
<html>
    ...
    <br>
    <c:if test="${task != null}">
        <form action="updateTaskCleaner" method="post" style="margin-right: 20%; margin-left: 20%;">
        </c:if>
        ...
        <div class="form-group row">
            <label for="inputEmail3" class="col-sm-2 col-form-label">Client's Name</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" value="<c:out value='${task.customerName}' />" id="inputEmail3" name="customername" required="required">
            </div>
        </div>
        <div class="form-group row">
            <label for="inputEmail4" class="col-sm-2 col-form-label">Client's Contact</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" value="<c:out value='${task.customerHpNo}' />" id="inputEmail4" name="customerhpno" required="required">
            </div>
        </div>
        <div class="form-group row">
            <label for="inputEmail5" class="col-sm-2 col-form-label">Assigned Staff</label>
            <div class="col-sm-10">
                <select class="form-control" id="staffid" name="staffid" required="required">
        ...
        <div class="form-group row">
            <div class="col-sm-10">
                ...
                <a href="taskListCleaner" class="custom-cancel btn-danger">Cancel</a>
            </div>
        </div>
    </form>
</body>
